...
if __name__ == '__main__':
    sys.path.append("../../..")
from pm_pycbio.tsv import TSVTable
from pm_pycbio.tsv import TSVError
from pm_pycbio.tsv import TSVReader
from pm_pycbio.sys.TestCaseBase import TestCaseBase
from pm_pycbio.sys import procOps
from pm_pycbio.hgdata.AutoSql import intArrayType
