...
# Had some issues with dependencies 
# Commented out everything not needed to run "pubPublishers publishers"
...
from os.path import *
import os, sys, optparse, logging, marshal, zlib, unicodedata, gc, shutil, random
try:
...
# Had some trouble getting things to import correctly, so I just commented out everything 
# not required for running "publishers"
...
pubResolvePublishers.initJournalDir(inDir, None, journalFname, publisherFname, use_base_files=True)
